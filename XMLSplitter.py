...
class XMLSplitter:
    def __init__(self):
        print("XML Splitter started")

    @classmethod
    def runSplitter(cls, newpath, splitText, concept_entry_count):
        parse(newpath, XMLBreaker(splitText, int(concept_entry_count), out=CycleFile(newpath)))